...
const QMetaObject Video_Form::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Video_Form.data,
      qt_meta_data_Video_Form,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Video_Form::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Video_Form.stringdata0))
        return static_cast<void*>(const_cast< Video_Form*>(this));
